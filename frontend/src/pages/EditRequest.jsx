...
export default function EditRequest() {
  ...
  if (request.status !== 'SUBMITTED') {
    return <Layout>
      <div style={{ padding: 20, background: '#f8d7da', borderRadius: 8, color: '#721c24' }}>
        Cette demande ne peut pas être modifiée car son statut est {request.status}.
  ...
  const handleSubmit = (e) => {
    ...
    updateRequest(request.id, { title, description, type });
    navigate('/dashboard');
  };
            ...
            <form onSubmit={handleSubmit} className="request-form">
              <div className="form-group">
                ...
                <input
                  ...
                  maxLength={100}
                  className={errors.some(e => e.includes('titre')) ? 'input-error' : ''}
                />
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  className={errors.some(e => e.includes('type')) ? 'input-error' : ''}
                >
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  className={errors.some(e => e.includes('description')) ? 'input-error' : ''}
                  rows={6}
                />
                <small style={{ color: '#666', marginTop: 4 }}>{description.length} caractères</small>
              </div>
              <div className="form-actions">
                <Button type="submit" variant="success" size="lg">Enregistrer les modifications</Button>
